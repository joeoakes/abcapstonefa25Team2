...
def shor_factor_generic(a, N, t=None, shots=1024, opt_level=3, approximation_degree=3):
    if math.gcd(a, N) != 1:
        return None, None
...
def plot_counts(counts, title="Shor measurement probabilities"):
    if not counts:
        return
    ...
    print(f"[plot] saved noiseless plot to {os.path.abspath('noiseless_plot.png')}")
